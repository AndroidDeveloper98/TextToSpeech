...
class SpeechToTextConverter(private val conversionCallback: ConversionCallback,private var ttsPlayPauseCallback: TTSPlayPauseCallback? = null)  : TranslatorFactory.IConverter {
