...
package com.innovation.texttospeech.translation_engine

import android.app.Activity
import com.innovation.texttospeech.translation_engine.translators.SpeechToTextConverter
import com.innovation.texttospeech.translation_engine.translators.TextToSpeckConverter
...
class TranslatorFactory private constructor() {
    ...
    fun with(TRANSLATORS: TRANSLATORS, conversionCallback: ConversionCallback, ttsPlayPauseCallback: TTSPlayPauseCallback? = null): IConverter {
        return when (TRANSLATORS) {
            TranslatorFactory.TRANSLATORS.TEXT_TO_SPEECH ->
                //Get Text to speech translator
                TextToSpeckConverter(conversionCallback,ttsPlayPauseCallback)

            TranslatorFactory.TRANSLATORS.SPEECH_TO_TEXT ->
                //Get speech to text translator
                SpeechToTextConverter(conversionCallback,ttsPlayPauseCallback)
        }
    }
